...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/kelvin-a-427025334/",
    color: "#0A66C2",
  ...
  //   subText: "@daracodes",
  //   icon: Youtube,
  //   url: "https://www.youtube.com/@daracodes",
  //   color: "#FF0000",
  ...
  // },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@designmyuiux-coder",
    icon: Github,
    url: "https://github.com/designmyuiux-coder",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const [ youtube, github, X ] = otherLinks;
