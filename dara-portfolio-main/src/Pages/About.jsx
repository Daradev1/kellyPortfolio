...
// Memoized Components
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%] mt-16">
    ...
    >
      ...
      Building simple, meaningful solutions that make a difference.
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1-jYzrihIc_bI_f91HpVC2QDZLOU-baFA/view?usp=drive_link" target="_blank" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
